...
const staticActivities = [
  {
    ...
    description: "Launching my personal portfolio website built with React and Tailwind CSS",
  ...
  },
  {
    ...
    description: "Participated in a 24-hour hackathon building a full-stack application",
  ...
  },
  {
    ...
    description: "Conducted a workshop on React hooks and state management",
...
const Gallery = () => {
    ...
    useEffect(() => {
        ...
        const savedActivities = localStorage.getItem('portfolioGalleryActivities');
        if (savedActivities) {
            try {
            ...
            setActivities(staticActivities);
            localStorage.setItem('portfolioGalleryActivities', JSON.stringify(staticActivities));
        }
        setIsLoading(false);
    }, []);
    ...
    const fetchComments = (galleryId) => {
        ...
        try {
            const savedComments = localStorage.getItem(`galleryComments_${galleryId}`);
            if (savedComments) {
    ...
    const handleLike = (e, activity) => {
        ...
        localStorage.setItem('portfolioGalleryActivities', JSON.stringify(updatedActivities));
    ...
    const handlePostComment = (e) => {
        ...
        try {
            ...
            localStorage.setItem(`galleryComments_${selectedActivity.id}`, JSON.stringify(updatedComments));
