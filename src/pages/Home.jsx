...
const Home = () => {
    ...
    const stats = [
        { icon: <FaCode />, value: "30+", title: "PROJECTS DELIVERED", description: "Scalable web applications & APIs built" },
        // { icon: <FaCertificate />, value: "13", title: "CERTIFICATES", description: "Professional skills validated" },
        { icon: <FaGlobe />, value: "7+", title: "YEARS OF EXPERIENCE", description: "Continuous learning journey" },
    ];
        ...
        >
          ...
          ${is3dEnabled
            ...
            <section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
                <div className="flex-1 dark:text-white text-slate-800 space-y-6 pt-16 md:pt-40 order-last md:order-none text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.55, ease: "easeOut" }}>
                        <TextGenerateEffect words={'Full-stack developer crafting scalable web solutions with PHP, Java, and modern frameworks.'} />
                    </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 1.0, ease: "easeOut" }} className="flex flex-row gap-4 mt-8">
                        ...
                        {/* <a href="https://www.linkedin.com/in/suhail-husain111/" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border dark:border-slate-700 border-slate-200 dark:bg-slate-900/[0.8] bg-white text-slate-600 dark:text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:shadow-md dark:hover:shadow-[0_0_24px_2px_#00ffdc]">
                        ...
                        <a href="https://www.linkedin.com/in/suhail-husain111" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border dark:border-slate-700 border-slate-200 dark:bg-slate-900/[0.8] bg-white text-slate-600 dark:text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:shadow-md dark:hover:shadow-[0_0_24px_2px_#00ffdc]">
            ...
            >
                ...
                <div className="flex flex-col md:flex-row items-center justify-center">
                    ...
                    >
                        ...
                        <h3 className="text-4xl font-bold dark:text-white text-slate-900 my-2 font-moderniz" style={{ textShadow: theme === 'dark' ? "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc" : "none" }}>SUHAIL HUSAIN</h3>
                        <p className="dark:text-white/80 text-slate-600 leading-relaxed mt-4 font-cascadia text-justify">
                            IT professional with over 7 years of hands-on experience in full-stack development, specialising in PHP (Laravel, Filament) and Java (Spring Boot). 
                            Proficient in database management using MySQL and PostgreSQL, with solid experience in Linux server environments. 
                            Skilled in front-end technologies including HTML, CSS, JavaScript, jQuery, and AJAX, with working knowledge of React JS for building dynamic and responsive user interfaces. 
                            Adept at delivering scalable, high-performance solutions and passionate about leveraging technology to solve complex problems.
                        </p>
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.5, ease: "easeOut", delay: 0.3 }} className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mt-10 px-4 md:px-0">
            ...
            <footer className="py-12 pb-16 text-center text-gray-400 dark:bg-gradient-to-t dark:from-slate-900/50 dark:to-transparent bg-gradient-to-t from-slate-100/50 to-transparent">
                <div className="text-sm">© {new Date().getFullYear()} SUHAIL HUSAIN. All rights reserved.</div>
