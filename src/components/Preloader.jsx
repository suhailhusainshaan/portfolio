...
const Preloader = ({ onFinished }) => {
  ...
  const fullText = "www.suhailhusain.dev";
        ...
        >
          {showContent && (
            ...
            >
              ...
              >
                <a href="https://github.com/suhailhusainshaan" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Github size={32} />
                </a>
                <a href="https://linkedin.com/in/suhail-husain111" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Linkedin size={32} />
                </a>
              </motion.div>
            </motion.div>
