...
import {
  ...
  FaJsSquare, FaTools, FaGithub, FaTimes, FaDownload, FaPhp, FaLinux
} from 'react-icons/fa';
import {
  SiTailwindcss, SiLaravel, SiSpring, SiMysql,
  SiPostgresql, SiJquery, SiRedis
} from 'react-icons/si';
...
const dummyProjects = [
  ...
  },
  {
    ...
    description: "Scalable e-commerce backend built with Spring Boot and MySQL. Features include JWT authentication, product catalog, shopping cart, and admin dashboard.",
  ...
  {
    title: "CMS Platform with Filament",
    description: "Content management system with a clean Filament admin panel, multi-tenancy support, media library, SEO tools, and custom role permissions. Optimised for performance on Linux servers.",
    tech: ["PHP", "Laravel", "Filament", "MySQL", "JavaScript", "AJAX"],
    link: "https://github.com/suhailhusainshaan",
    image: "https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?q=80&w=2055&auto=format&fit=crop",
    category: "Web/Apps",
  },
  {
    title: "REST API Gateway (Laravel)",
    description: "High-performance API gateway handling microservices orchestration, rate limiting, caching with Redis, and comprehensive logging. Serves as the backbone for multiple client applications.",
    tech: ["Laravel", "PostgreSQL", "Redis", "Linux", "REST API"],
    link: "https://github.com/suhailhusainshaan",
    image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=2034&auto=format&fit=crop",
    category: "Web/Apps",
  },
  {
    title: "Full-Stack Dashboard (React + Laravel)",
    description: "Real-time admin dashboard with React frontend and Laravel backend. Features interactive charts, data tables with server-side processing, user management, and WebSocket notifications.",
    tech: ["React", "Laravel", "MySQL", "JavaScript", "AJAX", "Linux"],
    link: "https://github.com/suhailhusainshaan",
...
const userCertificates = [
  ...
  },
  {
    ...
    date: "Sep 2024",
    link: "/certificates/SERTIFIKAT BNSP JUNIOR WEB DEVELOPER SUHAIL HUSAIN.jpeg",
    image: "/certificate-images/SERTIFIKAT BNSP JUNIOR WEB DEVELOPER SUHAIL HUSAIN.jpg",
  },
  {
...
const techStack = {
  ...
  backend: [
    ...
    { name: "Java", icon: <span className="text-[#007396]">☕</span> },
  ...
  tools: [
    { name: "Linux Server", icon: <FaLinux className="dark:text-white text-slate-900" /> },
    { name: "Git & GitHub", icon: <FaGithub className="dark:text-white text-slate-900" /> },
    { name: "AJAX", icon: <FaJsSquare className="text-[#F7DF1E]" /> },
...
const ProjectDetailModal = ({ project, onClose }) => {
  ...
  const techIcons = {
    "Laravel": <SiLaravel />, "Filament": "⚡", "PHP": <FaPhp />,
    "Java": "☕", "Spring Boot": <SiSpring />,
    "React": <FaReact />, "JavaScript": <FaJsSquare />, "jQuery": <SiJquery />,
    "HTML5": <FaHtml5 />, "CSS3": <FaCss3Alt />, "Tailwind CSS": <SiTailwindcss />,
    "MySQL": <SiMysql />, "PostgreSQL": <SiPostgresql />, "Redis": <SiRedis />,
    "Linux": <FaLinux />, "REST API": "🔌", "REST APIs": "🔌", "JWT": "🔑", "AJAX": "🔄", "Git & GitHub": <FaGithub />
  };
...
const ProjectCard = ({ project, onClick }) => {
  const techIcons = {
    "Laravel": <SiLaravel />, "Filament": "⚡", "PHP": <FaPhp />,
    "Java": "☕", "Spring Boot": <SiSpring />,
    "React": <FaReact />, "JavaScript": <FaJsSquare />, "jQuery": <SiJquery />, "AJAX": "🔄",
    "MySQL": <SiMysql />, "PostgreSQL": <SiPostgresql />, "Redis": <SiRedis />,
    "Linux": <FaLinux />, "REST API": "🔌", "REST APIs": "🔌", "JWT": "🔑"
  };
